...
export class DonationCampaignManager extends EntityManager<Campaign>  implements SearchableEntity<Campaign>
{
    ...
    async create(
        ...
        intervalNotificationValue: number,
        campaignManagerId: number | null,
        bankAccountId: number | null
    ): Promise<OperationResult<Campaign|null,FormError>>
    {
    ...
    async search(query: string, page: number, pageSize: number): Promise<OperationResult<Campaign[], SimpleError>> 
    {   
