...
export interface IRepositoryAsync<Entity extends IEntity> {
     ...
     * const users = await userRepo.getAll(["Address"], [{ column: "Users.id", order: "desc" }], 2);
     * ```
     */
     ...
     * const user = await userRepo.getByPrimaryKey([{ name: "Users.id", value: 20 }], ["Address"]);
     * ```
     */
     ...
     * const users = await userRepo.getByCondition([{ key: "Users.id", op: ">", value: 20 }], ["Address"], [{ column: "Users.id", order: "desc" }], 2);
     * ```
     */
     ...
     * const user = await userRepo.getFirstByCondition([{ key: "Users.id", op: ">", value: 20 }], ["Address"], [{ column: "Users.id", order: "desc" }], 2);
     * ```
     */
