...
export class NavigationKey<Entity extends IEntity> {
     ...
     *
     * @param {IEntity} parent - The parent entity that contains this navigation key.
     * @param {string} name - The name of this navigationKey variable for navigating to the correct field in the entity from this navigationObject.
     * @param {string} key - The Entity key name of the navigation key that is used in the relation.
     * @param {string} referencingTable - A referencing table is the one with the foreign key pointing to another table.
     * @param {string} referencingEntity - A referencing entity is the one that includes the others.
     * @param {string} referencedTable - The name of the table that the navigation key references.
     * @param {string} referencedColumn - The name of the column in the referenced table.
     * @param {string} referencedEntity - The name of the Entity that represents the referenced Table.
     * @param {Entity | Entity[] | null} [value=null] - The value of the referenced entity or collection of entities. Defaults to `null`.
     */
    constructor(
        parent: IEntity,
        name: string,
