...
const SideMenuNL: React.FC<SideMenuProps> = ({ isOpen, toggleMenu }) => {
  ...
  const shouldRenderMenuGroup = !(pathname === "/signin" || pathname === "/signup");
