...
const donorItemManager = new DonorBadgeManager();
...
export async function GET(request: NextRequest) {
    ...
    const donationsResult = await donorItemManager.getBadgeOfDonor(formData.donor_id, formData.page, formData.pageSize);
